...
def build_autostart_command() -> str:
    launcher_sh = Path("iniciar_monitor_github.sh").resolve()
    if launcher_sh.exists():
        return f'"{launcher_sh}"'
...
class FloatingBarApp:
    def __init__(
        ...
        self.title_label.grid(row=0, column=0, sticky="w", pady=(12, 0))
    ...
    def update_width_for_content(self) -> None:
        ...
        needed = (
            22
            + self.title_label.winfo_reqwidth()
            + 8
